import teachers, { president, sec, graphic, pr, excu } from "../assets/Team";
        ...
        <div className="flex justify-center flex-col items-center">
          ...
          <div className="border-b-2 border-solid border-[#002A42] lg:flex lg:justify-center lg:items-center lg:flex-col ">
            <p className="text-white text-sm text-left mb-2 lg:text-lg lg:w-[50rem] ">
              ...
              innovation meets leadership. Our dedicated council team, alongside
              our esteemed head teachers, works tirelessly to cultivate an
              environment of excellence and collaboration. Each member
              contributes a unique blend of expertise, passion, and vision,
              steering our department towards new horizons.
            </p>
